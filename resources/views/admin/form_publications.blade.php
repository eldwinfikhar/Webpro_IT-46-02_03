                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        placeholder="Enter publication title" value="{{ old('title', $publication->title) }}" required>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        placeholder="Enter publication author" value="{{ old('author', $publication->author) }}" required>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        placeholder="Enter publication year" value="{{ old('year', $publication->year) }}" required>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        placeholder="Enter publisher" value="{{ old('publisher', $publication->publisher) }}" required>
                                    </td>
                                </tr>
                                <tr>
